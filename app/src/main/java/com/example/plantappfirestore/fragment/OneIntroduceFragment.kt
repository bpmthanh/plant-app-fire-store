...
class OneIntroduceFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.imageView.setImageResource(R.drawable.image_introduce_one)
        binding.tvTitle.text = requireContext().getString(R.string.title_introduce_one)
        binding.tvDescription.text = requireContext().getString(R.string.description_introduce_one)
